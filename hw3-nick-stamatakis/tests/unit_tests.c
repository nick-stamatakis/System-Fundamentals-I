...
Test(base_suite, strglen_full_str_valgrind) {
    assert_no_valgrind_errors(run_using_system("strglen_full_str"));
}
...
Test(base_suite, strglen_number_str_valgrind) {
    assert_no_valgrind_errors(run_using_system("strglen_number_str"));
}
...
Test(base_suite, strglen_basic_valgrind) {
    assert_no_valgrind_errors(run_using_system("strglen_basic"));
}
...
Test(base_suite, strgLen_empty_str_valgrind) {
    assert_no_valgrind_errors(run_using_system("strgLen_empty_str"));
}
...
Test(base_suite, strgCopy_basic_valgrind) {
    assert_no_valgrind_errors(run_using_system("strgCopy_basic"));
}
...
Test(base_suite, strgCopy_complex_valgrind) {
    assert_no_valgrind_errors(run_using_system("strgCopy_complex"));
}
...
Test(base_suite, strgCopy_empty_valgrind) {
    assert_no_valgrind_errors(run_using_system("strgCopy_empty"));
}
...
Test(base_suite, strgChangeCase_basic_valgrind) {
    assert_no_valgrind_errors(run_using_system("strgChangeCase_basic"));
}
...
Test(base_suite, strgChangeCase_complex_valgrind) {
    assert_no_valgrind_errors(run_using_system("strgChangeCase_complex"));
}
...
Test(base_suite, strgChangeCase_empty_valgrind) {
    assert_no_valgrind_errors(run_using_system("strgChangeCase_empty"));
}
...
Test(base_suite, strgDiff_same_strings_valgrind) {
    assert_no_valgrind_errors(run_using_system("strgDiff_same_strings"));
}
...
Test(base_suite, strgDiff_diff_strings_valgrind) {
    assert_no_valgrind_errors(run_using_system("strgDiff_diff_strings"));
}
...
Test(base_suite, strgDiff_empty_strings_valgrind) {
    assert_no_valgrind_errors(run_using_system("strgDiff_empty"));
}
...
Test(base_suite, strgInterleave_basic_valgrind) {
    assert_no_valgrind_errors(run_using_system("strgInterleave_basic"));
}
...
Test(base_suite, strgInterleave_diff_lengths_valgrind) {
    assert_no_valgrind_errors(run_using_system("strgInterleave_diff_lengths"));
}
...
Test(base_suite, strgInterleave_empty_valgrind) {
    assert_no_valgrind_errors(run_using_system("strgInterleave_empty"));
}
...
Test(base_suite, encrypt_full_msg_numbers_valgrind) {
    assert_no_valgrind_errors(run_using_system("encrypt_full_msg_numbers"));
}
...
Test(base_suite, decrypt_full_msg_numbers_valgrind) {
    assert_no_valgrind_errors(run_using_system("decrypt_full_msg_numbers"));
}